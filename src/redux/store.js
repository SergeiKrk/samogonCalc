...
let store = {
  _state: {
    calcPage: {
      addDilutionWaterData: [{ id: 0, addwater: 0, afterDelution: 0 }],
      calculateHeadsData: [{ id: 0, volOutHeads: 0, volAbsAlcohol: 0 }],
      calculateTailsData: [{ id: 0, volOutHeads: 0, volAbsAlcohol: 0 }],
      ...
      calcsData: [
        {
          ...
          description:
            "Поможет расчитать и смешать дистиллят с водой в нужных пропорциях",
        },
        {
          id: 2,
