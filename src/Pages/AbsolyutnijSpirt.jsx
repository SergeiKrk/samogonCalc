        ...
        <Row>
          <Col className="text-left" md={{ span: 8, offset: 2 }}>
            ...
            <Card className="mb-4 mt-3" bg="light" border="dark" body>
              <p>
                <b>Абсолютный спирт</b> - теоретическое понятие (на практике его
                получить невозможно), подразумевающее этиловый спирт крепостью в
                100 градусов. Понятие "Абсолютный спирт" применяется для бытовых
