...
const OtborGolovCalc = (props) => {
    ...
    let addCalculateHeads = () => {
        ...
        let absAlcohol = (Number.parseInt(alcoholFortr) / Number.parseInt(alcoholVol) ).toFixed(2);
        let outHeads = (Number.parseInt(alcoholFortr) * Number.parseInt(partHeadVol) * 0.01 / Number.parseInt(alcoholVol) ).toFixed(2);
        props.addCalculateHeads(outHeads,absAlcohol);
    }
