...
const mapDispatchToProps = (dispatch) => {
    return {
        addCalculateFractional: (absAlcohol,reqVol,outHeads,outTails,distillingFortr) => {
            dispatch(addCalculateFractionalActionCreator(absAlcohol,reqVol,outHeads,outTails,distillingFortr));
        },
        updateAllDataFractional: (alcoholVol,alcoholFortr,distillingFortr,partHeadVol,partTailVol) => {
            dispatch(updateAllDataFractionalActionCreator(alcoholVol,alcoholFortr,distillingFortr,partHeadVol,partTailVol));
        }
    }
}

const DrobnayaPeregonkaCalcContainer = connect(mapStateToProps,mapDispatchToProps) (DrobnayaPeregonkaCalc);
