    ...
    <div>
      <HeaderBlock
        HeaderBlock={{
          ...
          Description:
            "Поможет подготовить спирт-сырец к дробной перегонке, расчитать пропорции и разбавить его до приемлемой крепости для производства качественного дистиллята",
