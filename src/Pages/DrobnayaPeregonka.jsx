    ...
    <div>
      <HeaderBlock
        HeaderBlock={{
          ...
          descriptionSeo:
            "Онлайн калькулятор быстро и точно рассчитает параметры дробной (второй) перегонки, подскажет как развести самогон (дистиллята) водой. Поможет расчитать объем хвостов и голов.",
